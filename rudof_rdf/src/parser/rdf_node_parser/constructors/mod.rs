...
macro_rules! combine_rdf_parser_impl {
    (
        ...
        impl<$($type_params)*> $crate::parser::rdf_node_parser::RDFNodeParse<$input_type>
            ...
            $($where_clause)*
        {
            ...
            fn parse_focused(
                &self,
                rdf: &mut $crate::parser::ParseCtx<'_, $input_type>,
            ) -> Result<Self::Output, $crate::RDFError> {
